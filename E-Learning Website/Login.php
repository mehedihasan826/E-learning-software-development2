	...
	<form action="" method="post">
		<table border=0 align="center">
			<tr>
				...
				<td><input type="text" class="form-control" name="id" placeholder="User Name"><br></td>
			</tr>
			<tr>
				<td><label>Enter Your Password: </label></td>
				<td><input type="password" class="form-control" name="pass" placeholder="Password"><br></td>
			</tr>
			<tr>
				<td colspan="2" align="center"><button name="btnsubmit" class="btn btn-block">Submit</button><br></td>
			</tr>
			<tr>
				<td colspan="2" align="center" ><button name="btnforget" class="btn btn-block">Forgot Password?</button><br></td>
			</tr>

			<tr>
				<td colspan="2" align="center" ><button class="btn btn-block"><a href="regi.php" >Create Account?</a></button></td>
			</tr>
